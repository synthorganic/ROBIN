 ...
 * when a newer version of ROBIN is available. Clicking it opens
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              ROBIN <span className="font-mono font-semibold text-foreground">v{versionInfo.latest}</span> is
          ...
          <div className="space-y-4 pt-2">
            <div>
              <p className="text-sm text-muted-foreground mb-2">
                Run this from the ROBIN project directory:
              </p>
            ...
            <div className="text-xs text-muted-foreground space-y-1">
              ...
              <p>If anything fails, ROBIN automatically rolls back to your current version.</p>
            </div>
            <div>

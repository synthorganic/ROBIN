...
/**
 * Top navigation bar for the ROBIN cockpit.
 *
 * Displays the ROBIN brand, and provides toggle buttons for the
    ...
    <div className="relative z-40 px-2 pt-2 sm:px-4 sm:pt-3">
      <header className="topbar-mobile-compact shell-panel flex min-h-14 flex-wrap items-center gap-x-3 gap-y-2 rounded-2xl px-3 py-2 shrink-0 max-[371px]:gap-x-1.5 max-[371px]:px-2 sm:flex-nowrap sm:px-4">
        <div className="flex min-w-0 items-center gap-3 max-[371px]:gap-2">
          <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-2xl border border-primary/20 bg-background/55 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] max-[371px]:h-9 max-[371px]:w-9">
            <img
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <span className="text-sm font-semibold uppercase tracking-[0.32em] text-foreground/90 sm:text-base">
                ROBIN
              </span>
              <span className="hidden text-[0.667rem] uppercase tracking-[0.22em] text-muted-foreground/80 sm:inline">
                Threat Detection
              </span>
            </div>
            <div className="hidden xl:block text-[0.733rem] text-muted-foreground/80">
              Local operator control surface
            </div>
          </div>
        </div>
        {/* View mode toggle */}

...
export async function synthesizeXiaomi(text, opts) {
    ...
    try {
        ...
        console.error('[tts:xiaomi] Failed to parse JSON:', err.message);
    ...
    try {
        ...
        console.error('[tts:xiaomi] Failed to decode audio:', err.message);

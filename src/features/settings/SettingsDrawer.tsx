...
function normalizeSavedCategory(value: string | null): SettingsCategory | null {
  ...
  if (raw === 'advanced' || raw === 'audio' || raw === 'appearance' || raw === 'lmstudio') return raw;
  return null;
}

const SETTINGS_CATEGORIES = [
  { key: 'lmstudio', label: 'LMStudio', icon: Settings },
      ...
      >
        ...
        <div className="flex-1 overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto px-4 py-5">
            ...
            {currentCategory === 'lmstudio' && <LMStudioSettings config={{ baseUrl: gatewayUrl }} onChange={(config) => onUrlChange(config.baseUrl)} />}

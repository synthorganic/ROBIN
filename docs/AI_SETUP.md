...
ROBIN supports agent-driven installation.
...
- **Hybrid / local ROBIN + remote gateway:** [DEPLOYMENT-B.md](./DEPLOYMENT-B.md)
...
1. confirm the ROBIN service or process is running
...
```text
Install ROBIN and make it reachable over Tailscale.
...
```text
Inspect my existing ROBIN install, repair it if needed, and validate it.

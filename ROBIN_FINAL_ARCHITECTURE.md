...
- **Transitional:** temporarily allowed while migrating.
...
- gateway WebSocket proxy `/ws`
- gateway `/tools/invoke`
- direct agent-facing `/api/execute/*`
- duplicate terminal/session routes not owned by the canonical supervisor

...
const EMPTY_EXCLUDED_NAMES = new Set();
const EMPTY_EXCLUDED_PATTERNS = [];
 ...
 */
export async function resolveWorkspacePathForRoot(workspaceRoot, relativePath, options) {
 ...
 */
export async function resolveWorkspacePath(relativePath, options) {
